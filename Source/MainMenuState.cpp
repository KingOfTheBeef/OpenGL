...
{
	Drawer::registerTexture("playbutton", "assets/playbutton.png");
	Drawer::registerTexture("exitbutton", "assets/exitbutton.png");
	Drawer::registerTexture("mainmenubackground", "assets/background.jpg");
