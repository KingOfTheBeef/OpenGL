...
{
	Drawer::registerTexture("background", "assets/playgamebackground.jpg");
	Drawer::registerTexture("player", "assets/soldier.bmp");
	Drawer::registerTexture("arrow", "assets/arrow.png");
	Drawer::registerTexture("barrel", "assets/barrel.png");
	Drawer::registerTexture("explode", "assets/explode.png");
